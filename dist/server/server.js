...
var webhooks_1 = require("../app/webhooks/stripe/webhooks");
var body_parser_1 = __importDefault(require("body-parser"));
dotenv_1.default.config({ path: [".env.local", ".env"] });
var app = (0, express_1.default)();
var PORT = process.env.PORT || 3000;
var PAYLOAD_SECRET = process.env.PAYLOAD_SECRET;
if (!PAYLOAD_SECRET) {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                next_utils_1.nextApp
                    ...
                    .catch(function (err) {
                    payload.logger.error("Error starting Next.js app: ".concat(err));
                });
                return [2 /*return*/];
        }
    });
