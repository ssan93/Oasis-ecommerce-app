...
var query_validator_1 = require("../../models/query-validator");
...
exports.productRouter = (0, trpc_1.router)({
    getProducts: trpc_1.publicProcedure
        ...
        var query, sort, limit, queryOpts, parsedQueryOpts, payload, products;
        var input = _b.input;
    ...
    getProductsByCategory: trpc_1.publicProcedure
        .input(zod_1.z.object({
        category: zod_1.z.string(),
        limit: zod_1.z.number().min(1).optional(),
    }))
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var category, limit, payload, docs, categoryId, products;
        var input = _b.input;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
    ...
    getCategoryId: trpc_1.publicProcedure
        .input(zod_1.z.object({ category: zod_1.z.string() }))
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var category, payload, docs;
        var input = _b.input;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
