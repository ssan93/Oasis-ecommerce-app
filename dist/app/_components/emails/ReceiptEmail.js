...
var ReceiptEmail = function (_a) {
    var email = _a.email, date = _a.date, orderId = _a.orderId, order = _a.order;
    var products_quantities = order.products_quantities.map(function (_a) {
    ...
    var total = products_quantities.reduce(function (acc, _a) {
        var product = _a.product, quantity = _a.quantity;
        return acc + product.price * quantity;
    }, 0) + constants_1.TRANSACTION_FEE;
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                ...
                products_quantities.map(function (_a) {
                    var _b, _c;
                    var product = _a.product, quantity = _a.quantity;
                    var image = (((_b = product.images) === null || _b === void 0 ? void 0 : _b[0]) || {}).image;
                    return (React.createElement(components_1.Section, { key: product.id },
                        React.createElement(components_1.Column, { style: { width: "64px" } }, typeof image !== "string" && (image === null || image === void 0 ? void 0 : image.url) ? (React.createElement(components_1.Img, { src: image.url, width: "64", height: "64", alt: "Product Image", style: productIcon })) : null),
                        React.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            product.description ? (React.createElement(components_1.Text, { style: productDescription }, product.description.length > 50
                                ? ((_c = product.description) === null || _c === void 0 ? void 0 : _c.slice(0, 50)) + "..."
                        ...
                        React.createElement(components_1.Column, { style: productPriceWrapper, align: "right" },
                            React.createElement(components_1.Text, { style: productPrice }, (0, formatters_1.formatPrice)(product.price * quantity)))));
                }),
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: "right" },
                        React.createElement(components_1.Text, { style: productPrice }, (0, formatters_1.formatPrice)(constants_1.TRANSACTION_FEE)))),
                ...
                React.createElement(components_1.Section, { align: "right" },
                    ...
                    React.createElement(components_1.Column, { style: productPriceLargeWrapper },
                        React.createElement(components_1.Text, { style: productPriceLarge }, (0, formatters_1.formatPrice)(total)))),
